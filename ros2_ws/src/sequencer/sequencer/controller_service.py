...
class Controller(Node):
    ...
    def execute_callback(self, goal_handle):
        ...
        data = goal_handle.request.commands

        feedback_msg = Sequencer.Feedback()
        ...
        if (trigger['action'] == 'MoveXYZW'): 
            ...
            print("The program will be closed. Bye!")
            self.get_logger().info("ERROR: Program finished since ACTION NAME in step number -> " + str(i) + " was not identified.")
