...
panda_gripper_path = '/home/azzam/RBE_595_Group_Project/ros2_ws/src/capgrasp_srv_cli/capgrasp_srv_cli/gripper_models/panda_pc.npy'

# GRIPPER_PC = np.load(gripper_model_path+'gripper_models/panda_pc.npy',
#                      allow_pickle=True).item()['points']
GRIPPER_PC = np.load(panda_gripper_path,
                     allow_pickle=True).item()['points']
GRIPPER_PC[:, 3] = 1.
...
def get_control_point_tensor(batch_size, use_torch=True, dense=False, device="cpu"):
    ...
    control_points = np.load('/home/azzam/RBE_595_Group_Project/ros2_ws/src/capgrasp_srv_cli/capgrasp_srv_cli/gripper_control_points/panda.npy')[:,:3]
    if dense:
...
def read_checkpoint_args(folder_path):
    root_dir = "/home/azzam/RBE_595_Group_Project/ros2_ws/src/capgrasp_srv_cli/capgrasp_srv_cli"
    return edict(yaml.safe_load(open(os.path.join(root_dir,folder_path, 'opt.yaml'))))
